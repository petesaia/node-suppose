...
function Suppose(cmd, args, opts) {
  ...
  this.opts = opts || {}
  this.opts.exe = this.opts.exe || spawn;

  this.opts.stdinProperty = 'undefined' !== typeof this.opts.stdinProperty ?
    this.opts.stdinProperty :
    'stdin'

  this.opts.stdoutProperty = 'undefined' !== typeof this.opts.stdoutProperty ?
    this.opts.stdoutProperty :
    'stdout'

  this.opts.exeConfig = 'undefined' !== typeof this.opts.exeConfig ?
    this.opts.exeConfig :
    {
      cwd: process.cwd(),
      env: process.env,
